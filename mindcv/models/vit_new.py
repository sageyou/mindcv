...
from mindspore.common.initializer import TruncatedNormal, initializer, HeUniform
...
__all__ = [
    ...
    "vit_b_16_224_new",
    "vit_b_16_384",
    "vit_l_16_224_new",  # with pretrained weights
    "vit_l_16_384",
    "vit_b_32_224_new",  # with pretrained weights
    "vit_b_32_384",
    "vit_l_32_224_new",  # with pretrained weights
]
...
class VisionTransformer(nn.Cell):
    ...
    def __init__(
        ...
        # todo: 看这里为什么是0.1 看是因为有的地方会用到吗？
        init_values: Optional[float] = None,
        no_embed_class: bool = False,
        pre_norm: bool = False,
        # todo: 建立vit的时候需要把这个默认值设置成False吗？
        ...
        **kwargs
        ...
        num_patches = self.patch_embed.num_patches  # todo: when dynamic pad : the num_patches?
...
@register_model
def vit_b_16_224_new(pretrained: bool = False, num_classes: int = 1000, in_channels: int = 3, **kwargs):
...
@register_model
def vit_l_16_224_new(pretrained: bool = False, num_classes: int = 1000, in_channels: int = 3, **kwargs):
...
@register_model
def vit_b_32_224_new(pretrained: bool = False, num_classes: int = 1000, in_channels: int = 3, **kwargs):
...
@register_model
def vit_l_32_224_new(pretrained: bool = False, num_classes: int = 1000, in_channels: int = 3, **kwargs):
